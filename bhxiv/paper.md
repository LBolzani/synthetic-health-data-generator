...
Once the synthetic health data is generated, one should evaluate the quality, applicability and privacy of the synthetic data. This is a hot topic of research and the community has not reached yet a consensus on how to do this assessement. The second challenge was to evaluate the quality of the generated synthetic dataset to know whether the model and the data are actually useful. Here, we explored and discussed some metrics and tools with the ultimate goal to propose them to the OpenEBench community.  
